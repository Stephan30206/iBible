...
const styles = StyleSheet.create({
  ...
  testamentSub: { fontSize: SIZES.sm, opacity: 0.9, fontWeight: '600' },
  testamentCount: { fontSize: SIZES.xs, fontWeight: '700', opacity: 0.8, marginTop: SIZES.s1 },
  ...
  statVal: { fontSize: SIZES.xl, fontWeight: '700', color: COLORS.textPrimary },
  statLabel: { fontSize: SIZES.xs, color: COLORS.textMuted, marginTop: 1 },
